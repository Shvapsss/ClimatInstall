...
class __TwigTemplate_953817975a32d62d9647e3ea7d69042ef85a2e1aa03e111a0eb48591df292733 extends Twig_Template
{
...
";
        ...
        if (trim((isset($context["html"]) ? $context["html"] : null))) {
         ...
         class=\"g-block";
            // line 25
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", array()), "variations", array())) ? ((" " . twig_escape_filter($this->env, twig_join_filter($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", array()), "variations", array()), " ")))) : ("")), "html", null, true);
            ...
            echo " ";
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('toGrid')->getCallable(), array($this->getAttribute($this->getAttribute((isset($context["segment"]) ? $context["segment"] : null), "attributes", array()), "size", array()))), "html", null, true);
            echo "\">
        ";
            // line 26
