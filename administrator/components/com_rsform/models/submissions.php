...
class RSFormModelSubmissions extends JModelLegacy
{
	...
	{
		$mainframe = JFactory::getApplication();
		return $mainframe->getUserStateFromRequest('com_rsform.submissions.dateFrom', 'dateFrom');
	}
	
	function getDateTo()
	{
		$mainframe = JFactory::getApplication();
		return $mainframe->getUserStateFromRequest('com_rsform.submissions.dateTo', 'dateTo');
	}
