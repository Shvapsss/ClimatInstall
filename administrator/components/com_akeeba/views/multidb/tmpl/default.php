...
akeeba.jQuery(document).ready(function($){
    ...
    akeeba.System.params.AjaxURL = '<?php echo AkeebaHelperEscape::escapeJS(JUri::base().'index.php?option=com_akeeba&view=multidb&task=ajax') ?>';
	// Set the media root
    akeeba.Multidb.loadingGif = '<?php echo $this->mediadir ?>../icons/loading.gif';
	...
	// Push translations
    akeeba.Multidb.translations['UI-ROOT'] = '<?php echo AkeebaHelperEscape::escapeJS(JText::_('FILTERS_LABEL_UIROOT')) ?>';
    akeeba.Multidb.translations['UI-ERROR-FILTER'] = '<?php echo AkeebaHelperEscape::escapeJS(JText::_('FILTERS_LABEL_UIERRORFILTER')) ?>';
<?php
	$keys = array(
	...
	foreach($keys as $key)
	{
		echo "\takeeba.Multidb.translations['".$key."'] = '".AkeebaHelperEscape::escapeJS(JText::_($key))."';\n";
	}
?>
