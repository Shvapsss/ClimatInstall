...
<script type="text/javascript" language="javascript">
    akeeba.Restore.password = '<?php echo $this->password; ?>';
	akeeba.Restore.ajaxURL = '<?php echo JUri::base() ?>/components/com_akeeba/restore.php';
    akeeba.Restore.mainURL = '<?php echo JUri::base() ?>/index.php';

    akeeba.Restore.translations['UI-LASTRESPONSE'] = '<?php echo AkeebaHelperEscape::escapeJS(JText::_('BACKUP_TEXT_LASTRESPONSE')) ?>';
