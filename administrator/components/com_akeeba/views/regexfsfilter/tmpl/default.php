...
akeeba.jQuery(document).ready(function($){
    ...
    akeeba.System.params.AjaxURL = '<?php echo AkeebaHelperEscape::escapeJS(JUri::base().'index.php?option=com_akeeba&view=regexfsfilter&task=ajax') ?>';
	...
	// Push translations
    akeeba.Regexfsfilters.translations['UI-ROOT'] = '<?php echo AkeebaHelperEscape::escapeJS(JText::_('FILTERS_LABEL_UIROOT')) ?>';
    akeeba.Regexfsfilters.translations['UI-ERROR-FILTER'] = '<?php echo AkeebaHelperEscape::escapeJS(JText::_('FILTERS_LABEL_UIERRORFILTER')) ?>';
...
<?php
	...
	{
		echo "\takeeba.Regexfsfilters.translations['UI-FILTERTYPE-REGEX".strtoupper($type)."'] = '".
