...
// For Joomla! 1.7
@include_once JPATH_ROOT . '/includes/version.php';
...
You are currently running Joomla! $jversion. Automatic update checks and update
installation from a CLI CRON job are only supported on Joomla! 3.2.0 and later.
Older versions of Joomla! lack the ability to properly install updates from the
command line.

You can still update Akeeba Backup by downloading and installing the new
version on top of the old one, without uninstalling the old version.
